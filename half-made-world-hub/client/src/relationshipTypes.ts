...
export const RELATIONSHIP_TYPES: Record<string, RelType> = {
  ...
  knows: { label: 'Knows', color: '#c8a876' },
  'unaware of': { label: 'Unaware of', color: '#7f8fa3', dashed: true },
  ...
  'friend of': { label: 'Friend of', color: '#4ade80' },
  opposes: { label: 'Opposes', color: '#f87171' },
  watches: { label: 'Watches', color: '#7f8fa3', dashed: true },
...
export const FALLBACK_REL = { label: 'Related to', color: '#7f8fa3' };
