...
module.exports = [
  ...
  s("Mend-and-Rend", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Mend-and-Rend", "Holy Mend", "fused from", "Fused from", "Fuses the angel skill Holy Mend."),
  s("Mend-and-Rend", "Fading Wound", "fused from", "Fused from", "Fuses the demon skill Fading Wound."),
  ...
  s("Vexstep", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Vexstep", "Swiftstep", "fused from", "Fused from", "Fuses the angel skill Swiftstep."),
  s("Vexstep", "Traitor’s Step", "fused from", "Fused from", "Fuses the demon skill Traitor's Step."),
  ...
  s("Lapsing Miasma", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Lapsing Miasma", "Lapse", "fused from", "Fused from", "Fuses the angel skill Lapse."),
  s("Lapsing Miasma", "Grey Miasma", "fused from", "Fused from", "Fuses the demon skill Grey Miasma."),
  s("Rewound Double", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Rewound Double", "Rewind", "fused from", "Fused from", "Fuses the angel skill Rewind."),
  s("Rewound Double", "Blood Jape", "fused from", "Fused from", "Fuses the demon skill Blood Jape."),
  s("Sealed Hour", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Sealed Hour", "Still Hour", "fused from", "Fused from", "Fuses the angel skill Still Hour."),
  s("Sealed Hour", "Seal", "fused from", "Fused from", "Fuses the demon skill Seal."),
  s("Sight of Threads", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Sight of Threads", "Long Sight", "fused from", "Fused from", "Fuses the angel skill Long Sight."),
  s("Sight of Threads", "Bond-Sight", "fused from", "Fused from", "Fuses the demon skill Bond-Sight."),
  s("Sunburst", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Sunburst", "Burning Path", "fused from", "Fused from", "Fuses the angel skill Burning Path."),
  s("Sunburst", "Cornucopia", "fused from", "Fused from", "Fuses the demon skill Cornucopia."),
  s("Gorged Sun", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Gorged Sun", "Second Sun", "fused from", "Fused from", "Fuses the angel skill Second Sun."),
  s("Gorged Sun", "Glut", "fused from", "Fused from", "Fuses the demon skill Glut."),
  s("War-Frenzy", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("War-Frenzy", "Battle Trance", "fused from", "Fused from", "Fuses the angel skill Battle Trance."),
  s("War-Frenzy", "Berserk (Bloodward)", "fused from", "Fused from", "Fuses the demon skill Berserk (Bloodward)."),
  s("Grasp-and-Reap", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Grasp-and-Reap", "Ravager’s Grasp", "fused from", "Fused from", "Fuses the angel skill Ravager's Grasp."),
  s("Grasp-and-Reap", "Reap", "fused from", "Fused from", "Fuses the demon skill Reap."),
  s("War-Sated", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("War-Sated", "War-Worn", "fused from", "Fused from", "Fuses the angel skill War-Worn."),
  s("War-Sated", "Unslaked", "fused from", "Fused from", "Fuses the demon skill Unslaked."),
  s("Dread Toll", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Dread Toll", "Dread-Herald", "fused from", "Fused from", "Fuses the angel skill Dread-Herald."),
  s("Dread Toll", "Widow’s Toll", "fused from", "Fused from", "Fuses the demon skill Widow's Toll."),
  s("Unheard Whisper", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Unheard Whisper", "Unheralded", "fused from", "Fused from", "Fuses the angel skill Unheralded."),
  s("Unheard Whisper", "Red Whisper", "fused from", "Fused from", "Fuses the demon skill Red Whisper."),
  s("Dreadbind", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Dreadbind", "Dreadweight", "fused from", "Fused from", "Fuses the angel skill Dreadweight."),
  s("Dreadbind", "Heart-Bind", "fused from", "Fused from", "Fuses the demon skill Heart-Bind."),
  s("Bound Rite", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Bound Rite", "Altar-Rite", "fused from", "Fused from", "Fuses the angel skill Altar-Rite."),
  s("Bound Rite", "Blood Pact", "fused from", "Fused from", "Fuses the demon skill Blood Pact."),
  s("Oathbrand", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Oathbrand", "Vowbrand", "fused from", "Fused from", "Fuses the angel skill Vowbrand."),
  s("Oathbrand", "Blood-Oath", "fused from", "Fused from", "Fuses the demon skill Blood-Oath."),
  s("Bitter Truth", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Bitter Truth", "Truthvein", "fused from", "Fused from", "Fuses the angel skill Truthvein."),
  s("Bitter Truth", "Guile", "fused from", "Fused from", "Fuses the demon skill Guile."),
  s("Eye of Ruin", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Eye of Ruin", "All-Seeing Eye", "fused from", "Fused from", "Fuses the angel skill All-Seeing Eye."),
  s("Eye of Ruin", "Veyn Decomposition (Bloodward)", "fused from", "Fused from", "Fuses the demon skill Veyn Decomposition (Bloodward)."),
  s("Recall of the Buried", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Recall of the Buried", "Warden’s Recall", "fused from", "Fused from", "Fuses the angel skill Warden's Recall."),
  s("Recall of the Buried", "Disinter", "fused from", "Fused from", "Fuses the demon skill Disinter."),
  s("Draining Mark", "Jaiden Marlock — True Hybrid Form", "skill of", "Skill of", "A hybrid skill of the True Hybrid Form."),
  s("Draining Mark", "Warden’s Mark", "fused from", "Fused from", "Fuses the angel skill Warden's Mark."),
  s("Draining Mark", "Siphon", "fused from", "Fused from", "Fuses the demon skill Siphon."),
