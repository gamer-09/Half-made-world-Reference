...
module.exports = [
  ...
  e(
    ...
    [
      { label: "Level Range", value: "25 - 99" },
      { label: "Early Stage", value: "Levels 25-49" },
      { label: "Mid Stage", value: "Levels 50-74" },
      { label: "Late Stage", value: "Levels 75-94" },
      { label: "Peak Stage", value: "Levels 95-99" },
    ],
  ...
  e(
    ...
    [
      { label: "Level Range", value: "100 - 199" },
      { label: "Early Stage", value: "Levels 100-129" },
      { label: "Mid Stage", value: "Levels 130-159" },
      { label: "Late Stage", value: "Levels 160-189" },
      { label: "Peak Stage", value: "Levels 190-199" },
  ...
  e(
    ...
    [
      { label: "Level Range", value: "200 - 349" },
      { label: "Early Stage", value: "Levels 200-249" },
      { label: "Mid Stage", value: "Levels 250-299" },
      { label: "Late Stage", value: "Levels 300-339" },
      { label: "Peak Stage", value: "Levels 340-349" },
  ...
  e(
    ...
    [
      { label: "Level Range", value: "350 - 499" },
      { label: "Early Stage", value: "Levels 350-399" },
      { label: "Mid Stage", value: "Levels 400-449" },
      { label: "Late Stage", value: "Levels 450-489" },
      { label: "Peak Stage", value: "Levels 490-499" },
      { label: "Max Lifespan", value: "100,000+ years" },
    ],
  ...
  e(
    ...
    [
      { label: "Level Range", value: "500 - 749" },
      { label: "Early Stage", value: "Levels 500-574" },
      { label: "Mid Stage", value: "Levels 575-649" },
      { label: "Late Stage", value: "Levels 650-724" },
      { label: "Peak Stage", value: "Levels 725-749" },
  ...
  e(
    ...
    [
      { label: "Level Range", value: "750 - 999" },
      { label: "Early Stage", value: "Levels 750-824" },
      { label: "Mid Stage", value: "Levels 825-899" },
      { label: "Late Stage", value: "Levels 900-974" },
      { label: "Peak Stage", value: "Levels 975-999" },
  ...
  e(
    ...
    [
      { label: "Ranks", value: "Stirrer → Mixer → Brewer → Compounder → Transmuter → Elixir Lord → Grand Alchemist" },
      { label: "Stirrer", value: "Basic tonics, simple healing drinks, identifies common ingredients" },
      { label: "Mixer", value: "Compound potions, basic poisons, can handle minor Veyn-infused ingredients" },
  ...
  e(
    ...
    [
      { label: "Stages", value: "Whisperer → Bonded → Twin-Soul → Pack Leader → Wild Sovereign → Apex Predator → Alpha Eternal" },
  ...
  e(
    ...
    [
      { label: "Tiers", value: "Apprentice Smith → Journeyman Smith → Forgemaster → Bloodforger → Runesmith → Mythic Forger → Grand Forger" },
      { label: "Apprentice Smith", value: "Shapes basic steel, creates functional weapons and armor with basic Veyn reinforcement" },
      { label: "Journeyman Smith", value: "Veyn infusion during forging, creates minor magical properties, handles Ren channeling" },
  ...
  e(
    ...
    [
      { label: "Grades", value: "Rune Reader → Rune Writer → Rune Shaper → Rune Weaver → Rune Lord → Rune Sage → Rune Transcendent" },
      { label: "Rune Reader", value: "Identifies enchantments on items, reads their function and strength" },
      { label: "Rune Writer", value: "Creates simple lasting enchantments on ordinary items" },
      { label: "Rune Shaper", value: "Channels Veyn into finished items, creates stronger magical effects" },
      { label: "Rune Weaver", value: "Fuses compatible enchantments, removes and enhances existing ones" },
  ...
  e(
    ...
    [
      { label: "Levels", value: "Glimpse → Peeker → Watcher → Seer → Oracle → Prophet → Cosmic Sight" },
      { label: "Glimpse", value: "Detects obvious lies, basic True-Sight, senses strong Veyn presence" },
      { label: "Peeker", value: "Sees through magical concealment, detects hidden beings, reads basic auras" },
  ...
  e(
    ...
    [
      { label: "Stages", value: "Cleaner → Warder → Binder → Purifier → Exorcist → Grand Exorcist → Eternal Seal-Bearer" },
      ...
      { label: "Exorcist", value: "Purified Veyn strikes deal heavy damage to corrupted beings, handles mass contamination" },
  ...
  e(
    ...
    [
      { label: "Stages", value: "Flicker → Glow → Radiance → Brilliance → Blazing Light → Divine Radiance → Seraphic Aura" },
      { label: "Flicker", value: "Emits faint healing warmth, basic wound mending, weak corruption resistance" },
  ...
  e(
    ...
    [
      { label: "Ranks", value: "Tender → Mender → Restorer → Healer → High Healer → Saint Healer → Life Weaver" },
      { label: "Tender", value: "Basic wound care, applies Veyn to minor cuts and bruises, first aid" },
      { label: "Mender", value: "Heals broken bones and deep lacerations, creates healing barriers for allies" },
  ...
  e(
    ...
    [
      { label: "Tiers", value: "Marksman → Sharpshooter → Enchanter Archer → Spell Archer → Storm Archer → Void Archer → Cosmic Marksman" },
  ...
  e(
    ...
    [
      { label: "Ranks", value: "Bone Worker → Grave Tender → Corpse Speaker → Death Adept → Necromancer → Grave Lord → Death Sovereign" },
      { label: "Bone Worker", value: "Reanimates simple remains, issues basic commands, uses remains as disposable shields" },
      { label: "Grave Tender", value: "Controls multiple undead, drains Veyn from corpses, basic necrotic pulses" },
      { label: "Corpse Speaker", value: "Binds spirits to remains for smarter undead, creates bone projectiles" },
      { label: "Death Adept", value: "Reanimates large groups, creates undead legions, enhanced necrotic attacks" },
  ...
  e(
    ...
    [
      { label: "Stages", value: "Angry → Furious → Enraged → Wrathful → Berserk → Warlord → Avatar of War" },
      { label: "Angry", value: "Controlled rage increases strength and pain tolerance, basic war howl" },
      { label: "Furious", value: "Stronger rage surges, devastating single attacks, Ren burst for area damage" },
      { label: "Enraged", value: "Fights through wounds that would stop others, powerful crippling blows" },
      { label: "Wrathful", value: "Full berserk mode increases strength and speed dramatically, rage burst knocks back enemies" },
  ...
  e(
    ...
    [
      { label: "Ranks", value: "Guard → Shield Bearer → Warden → Fortress → Bulwark → Immortal Guardian → Eternal Sentinel" },
      ...
      { label: "Fortress", value: "Designates ally to protect, automatically intercepts attacks aimed at them" },
      { label: "Bulwark", value: "Survives lethal damage once per battle, fights through severe injury" },
  ...
  e(
    ...
    [
      { label: "Stages", value: "Novice Archer → Ren Touched → Crimson Archer → Storm Bow → Phantom Archer → Void Striker → Arrow Sovereign" },
  ...
  e(
    ...
    [
      { label: "Tiers", value: "Lurker → Shadow Walker → Phantom → Ghost → Wraith → Shadow Lord → Living Shadow" },
      { label: "Lurker", value: "Suppresses sound, basic shadow movement, lock picking with Ren" },
      { label: "Shadow Walker", value: "Moves through dim light invisibly, enhanced reflexes, poison blade coating" },
  ...
  e(
    ...
    [
      { label: "Depths", value: "Student → Researcher → Lorekeeper → Archivist → Scholar → Sage → World Reader" },
      { label: "Student", value: "Learns basic Shudon construction, identifies age and origin of fragments" },
      { label: "Researcher", value: "Repairs inactive Shudon, reads ancient inscriptions, studies golem lore" },
  ...
  e(
    ...
    "The ranks of the guild — trust in the seal",
    "Silver Concord ranks its members not by raw power or Grade, but by how far the guild trusts them with its seal. Every rank reflects a step in the life of a contract — from witnessing one, to drafting it, to signing it, to ruling on it when it breaks. A member’s Grade and class are irrelevant to guild rank: a low-Grade Scribe can rise to Arbiter on pure reliability, while a high-Grade mercenary may never rise past Witness if the guild does not trust their word. Advancement is earned through completed contracts, sound judgment, and an unbroken record — the same iron rule that made the guild’s name.",
    [
      { label: "Ranks", value: "Witness → Scribe → Signatory → Mediator → Arbiter → Guildmaster" },
      { label: "Witness", value: "New members. They observe contracts and learn the guild’s rules under supervision, but may not touch the seal." },
      { label: "Scribe", value: "Drafts and records contracts. Can witness standard agreements, but every seal they carry is countersigned by a Signatory." },
      { label: "Signatory", value: "Authorized to sign and carry the guild’s seal on standard contracts. Trusted to handle low-risk Cross-realm deals on their own." },
      { label: "Mediator", value: "Mediates disputes between parties and handles sensitive negotiations. May oversee complex contracts and mentor lower ranks." },
      { label: "Arbiter", value: "Rules on broken contracts and enforces the seal. Leads contract teams, represents the guild to rulers, and oversees branch operations." },
      { label: "Guildmaster", value: "A single, unique rank. Holds the guild’s master seal and is the final authority on every contract and dispute — currently Varen Ashtail." },
    ],
  ...
  e(
    ...
    [
      ...
      { label: "Rank", value: "B-rank (Grade System)" },
